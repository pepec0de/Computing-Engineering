...
public class Member1 implements Serializable {
    ...
    public Member1(String mNum, String mName, String mId, String mBirhtdate, String mPhone, String mEmailmember, String mStartingdatemember, Character mCathegorymember) {
        this.mNum = mNum;
        this.mName = mName;
        this.mId = mId;
