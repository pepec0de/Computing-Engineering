...
nClases = 26;
nImagenesClase = 2;
codifClases = 1:nClases;
nombresClases = num2cell('A':'Z');
simbolosClases = {'*r', '*g', '*b', '*c', '*m', '*y', '*k', '*r', '*g', '*b', '*c', '*m', '*y', '*k', '*r', '*g', '*b', '*c', '*m', '*y', '*k', '*m', '*y', '*k', '*r', '*g'};
...
for img = 1:nImagenesClase
    ...
    nombreImagen = [datosProblema.clases{clase} num2str(img, "%01d") '.tif'];
