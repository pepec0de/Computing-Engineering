...
void TestOrdenacion::casoMedio(int metodo)
{
	...
	/* Generar grafica */
	char opc;
	cout << endl << "Generar gr�fica de resultados? (s/n): ";
	cin >> opc;
	switch (opc) {
	case 's':
	case 'S': {
...
void TestOrdenacion::comparar(int metodo1, int metodo2) {
	...
	cout << endl << "Comparaci�n de los algoritmos de ordenaci�n: " << nombreAlgoritmo[metodo1] << " y " << nombreAlgoritmo[metodo2] << endl;
